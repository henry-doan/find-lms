...
class CodingII extends Component {
  ...
  render() {
    return(
      <div className='container'>
        <h1>Coding II Lessons</h1>
        <hr />
        <Collection header='Week 1'>
          <CollectionItem>
            <Link to='codingII-lessons/1'>Lesson 1</Link>
          </CollectionItem>
          <CollectionItem>
            <Link to='codingII-lessons/2'>Lesson 2</Link>
          </CollectionItem>
          <CollectionItem>
            <Link to='codingII-lessons/3'>Lesson 3</Link>
          </CollectionItem>
        </Collection>
      </div>
    )
